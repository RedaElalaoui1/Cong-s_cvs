        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex justify-between">
                  <div class="w-72 flex justify-center items-start">
                    <!-- search -->
                    <form class="w-full flex items-center" action="/search_emp" type="get"> 
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="py-4 px-6">
                            <a href="/update_employee/{{ $emp->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                            <div>
                                
                                <a href="/delete_employee/{{ $emp->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline " onclick="return(confirm('Etes-vous sûr de vouloir supprimer?'))"> delete</a>
                            </div>
                        </td>
                    </tr>
                    @endforeach
